...
class ResNet(nn.Module):
    def __init__(self, nInputChannels, block, layers, os=32, pretrained=True):
        self.inplanes = 64
    ...
    def _load_pretrained_model(self):
        pretrain_dict = torch.load('/media/SecondDisk/chenguanqi/thyroid_seg/pre_train/resnet101-5d3b4d8f.pth')
        model_dict = {}
